...
fig = _plot_displacements()
savefig(fig, "u_node700.pdf")

# ================================
# graficos desplazamientos (ZOOM)
# ================================

function _plot_displacements_zoom()
...
fig = _plot_displacements_zoom()
savefig(fig, "u_node700_zoom.pdf")

# =========================
# velocidad
# =========================

function _plot_velocity()
...
fig = _plot_velocity()
savefig(fig, "v_node700.pdf")

# ==============================
# graficos velocidad (ZOOM)
# ==============================

function _plot_velocity_zoom()
...
fig = _plot_velocity_zoom()
savefig(fig, "v_node700_zoom.pdf")
