...
%[ mesh.nodesCoords, mesh.conecCell ] = meshFileReader( 'lambsProblemDomain_mesh1.msh' ) ;
%[ mesh.nodesCoords, mesh.conecCell ] = meshFileReader( 'lambsProblemDomain_mesh2.msh' ) ;
[ mesh.nodesCoords, mesh.conecCell ] = meshFileReader( 'lambsProblemDomain_mesh3.msh' ) ;

save('-mat', 'output/mesh.mat', 'mesh' );
