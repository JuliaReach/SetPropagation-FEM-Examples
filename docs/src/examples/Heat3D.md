```@meta
EditURL = "<unknown>/examples/Heat3D/Heat3D.jl"
```
...
using SetPropagation_FEM_Examples

using Plots
using Plots.PlotMeasures
using LaTeXStrings

include(joinpath(@modelpath("Heat3D", "utils.jl")))
include(joinpath(@modelpath("Heat3D", "data.jl")))
